...
//        rooms.add(new Room("Jupiter Room", 600, RoomType.CRACOW, new BigDecimal(450.00), "cipher001"));
//        rooms.add(new Room("Saturn Room", 500, RoomType.GDANSK, new BigDecimal(400.00), "cipher002"));
//        return rooms;
//    }
//
